...
manos_data_path = '/Users/dennisbaumann/cars_paper/data/train/mano_8_train/'

mano_pred_path = '/Users/dennisbaumann/cars_paper/data/mano_train/'
cam_data_path = '/Users/dennisbaumann/cars_paper/data/train/cam_8_train/'
obj_data_path = '/Users/dennisbaumann/cars_paper/data/train/obj_8_train/'
#joint_data_path = '/Users/dennisbaumann/cars_paper/data/val/joint_8_val/'
obj_rt_data_path = '/Users/dennisbaumann/cars_paper/data/train/obj_rt_8_train/'
idxs = np.arange(228, 569)
# Generate random shape parameters
save_dir_hands = '/Users/dennisbaumann/cars_paper/data/train/hand_masks/'
save_dir_obj = '/Users/dennisbaumann/cars_paper/data/train/obj_masks/'
...
for idx in idxs:
    ...
    test_image = np.load(f'/Users/dennisbaumann/cars_paper/data/train/seq_8_train/{idx:03d}.npy')
    ...
    for k in range(8):
        ...
        plt.imshow(obj_mask, cmap='hot', interpolation='nearest', vmin=0, vmax=255)
        plt.show()
