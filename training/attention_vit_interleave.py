...
from utils.vit_train_utils_interleave import MultiModalDataset, Cars_Action,preprocess,set_seed, compute_soft_iou
...
def main():
    ...
    wandb.init(project="cars_action_project_arctic", name="Cars_Action_training_run_interleave")
    ...
    best_model_path = os.path.join(save_dir, "best_cars_action_model_interleave.pth")
    ...
    final_model_path = os.path.join(save_dir, "final_cars_action_model_interleave.pth")
